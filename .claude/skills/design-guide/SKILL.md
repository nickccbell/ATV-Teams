...
name: design-guide
description: >
  ATV-Teams UI design system guide for building consistent, reusable frontend
...
# ATV-Teams Design Guide

ATV-Teams's UI is a professional-grade control plane — dense, keyboard-driven, dark-themed by default. Every pixel earns its place.
...
2. **Custom composites** (`ui/src/components/`) — StatusBadge, EntityRow, MetricCard, etc. These capture ATV-Teams-specific design language.
