...
This document covers the GitHub and npm setup required for the current ATV-Teams release model:
...
Do this for every public package that ATV-Teams publishes.
...
2. revoke any personal automation token that used to publish ATV-Teams
