...
This document indexes every part of the ATV-Teams codebase that touches the [Agent Companies Specification](docs/companies/companies-spec.md) (`agentcompanies/v1-draft`).
...
| `server/src/services/routines.ts` | ATV-Teams routine runtime service. Portability now exports routines as recurring `TASK.md` entries and imports recurring tasks back through this service. |
