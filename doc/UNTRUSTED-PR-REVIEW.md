...
This is intentionally separate from the normal ATV-Teams dev image.
...
## Preview the ATV-Teams app from the PR
...
- ATV-Teams's embedded PostgreSQL and local storage stay inside the container home volume via `PAPERCLIP_HOME=/home/reviewer/.paperclip-review`.
