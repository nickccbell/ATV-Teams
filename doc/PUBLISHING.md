...
Low-level reference for how ATV-Teams packages are prepared and published to npm.
...
ATV-Teams no longer uses release branches or Changesets for publishing.
...
ATV-Teams uses calendar versions:
...
ATV-Teams does not auto-publish every non-private workspace package anymore.
