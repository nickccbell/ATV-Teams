...
This note inventories the ATV-Teams issues that point to the same UX class of problem:
...
Pattern: ATV-Teams already has several places where the right fix was "show intent immediately, then reconcile," not "wait for refetch."
