# ATV-Teams Skill Tightening Plan
...
- preserve all current ATV-Teams control-plane capabilities
...
- changing ATV-Teams API semantics
...
- add at least lightweight eval or scripted scenario coverage for key ATV-Teams flows
- confirm how adapter/bootstrap layering should load skill content versus references

## Success Criteria

- materially lower first-run input tokens for ATV-Teams-coordinated agents
