...
This document defines the rollout plan for adapter-wide skill support in ATV-Teams.
...
- ATV-Teams stores desired skill state consistently even when the adapter cannot fully reconcile it
- unsupported adapters degrade clearly and safely

## 2. Current Adapter Matrix

ATV-Teams currently has these adapters:
...
1. Desired skills live in ATV-Teams for every adapter.
...
These adapters have a stable local skills directory that ATV-Teams can read and manage.
...
These adapters do not have a meaningful ATV-Teams-owned persistent install state.
...
- desired skills stored in ATV-Teams
...
- runtime already injects ATV-Teams skills into `~/.cursor/skills`
...
- runtime already injects ATV-Teams skills into `~/.gemini/skills`
...
- runtime already injects ATV-Teams skills into `~/.pi/agent/skills`
...
- ATV-Teams can sync desired skills into Pi’s persistent home
...
- OpenCode currently injects ATV-Teams skills into `~/.claude/skills`

This is product-risky because:

- it shares state with Claude
- ATV-Teams may accidentally imply the skills belong only to OpenCode when the home is shared
...
- only remove stale managed ATV-Teams skills that are clearly marked as ATV-Teams-managed
...
- ATV-Teams stores desired skills only
...
- avoid destructive wording unless ATV-Teams can prove a skill is ATV-Teams-managed
...
That gets ATV-Teams from “skills work for Codex and Claude” to “skills work for the whole local-adapter family,” which is the meaningful V1 milestone.
