...
ATV-Teams already treats budgets as a core control-plane responsibility:
...
This plan defines the concrete budgeting model ATV-Teams should implement next.

## Product Goals

ATV-Teams should let operators:
...
For the next implementation pass, ATV-Teams should enforce these defaults:
...
ATV-Teams should separate subscription-included usage from billed spend:
...
ATV-Teams should have two threshold classes:
...
ATV-Teams must know that a project is budget-paused and enforce it.
...
ATV-Teams must also block execution before new work starts.
