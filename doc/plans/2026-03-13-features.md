...
- Team of 3 can use one shared ATV-Teams instance.
...
ATV-Teams should manage the **issue → workspace → preview/PR → review handoff** lifecycle, but leave diffs/review/merge to external tools.
...
- A chat plugin can converse without requiring chat to become the core ATV-Teams product.
...
- **Keep** ATV-Teams as the board-level control plane.
