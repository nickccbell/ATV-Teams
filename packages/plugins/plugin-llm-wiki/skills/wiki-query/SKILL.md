...
6. **When the wiki cannot answer**, say so plainly. Suggest a source the user should ingest, a ATV-Teams project that would help if distilled, or a web lookup. Never bluff.
