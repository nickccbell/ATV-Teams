...
const MANAGED_SKILLS = [
  ...
  { status: "resolved", skillId: "skl-llmw-distill", resourceKey: "paperclip-distill", details: { name: "ATV-Teams Distill", key: "plugin/paperclipai-plugin-llm-wiki/paperclip-distill", description: null } },
...
const PAGES = {
  ...
  sources: [
    ...
    { rawPath: "raw/paperclip-v1-spec.md", title: "ATV-Teams V1 spec", sourceType: "file", url: null, status: "captured", createdAt: "2026-05-01T18:30:00Z" },
...
A **plugin-managed resource** is a normal ATV-Teams resource (agent, routine, project) that a plugin has seeded with suggested defaults. The plugin marks ownership via a stable \`resourceKey\` so that installs, imports, and upgrades can find the resource even when UUIDs differ.
...
You maintain this wiki through ATV-Teams plugin tools.
