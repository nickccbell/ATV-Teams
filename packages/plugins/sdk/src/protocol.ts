 ...
 * channel.
 *
 * The ATV-Teams plugin runtime uses JSON-RPC 2.0 over stdio to communicate
 ...
 * we use strings (UUIDs or monotonic counters) for all ATV-Teams messages.
 */
...
/**
 * ATV-Teams plugin-specific error codes.
 *
...
export interface InitializeParams {
  ...
  instanceInfo: {
    /** UUID of this ATV-Teams instance. */
    instanceId: string;
    /** Semver version of the running ATV-Teams host. */
    hostVersion: string;
  };
  /** Host API version. */
  apiVersion: number;
