...
const manifest: PaperclipPluginManifestV1 = {
  ...
  description: "Reference plugin that demonstrates the current ATV-Teams plugin API surface, UI surfaces, bridge actions, events, jobs, webhooks, tools, local workspace access, and runtime diagnostics in one place.",
  author: "ATV-Teams",
  ...
  tools: [
    ...
    },
    {
      ...
      description: "Summarizes the current company using the ATV-Teams domain APIs.",
      parametersSchema: {
        type: "object",
        properties: {},
      },
