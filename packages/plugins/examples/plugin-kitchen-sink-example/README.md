...
Kitchen Sink is the first-party reference plugin that demonstrates nearly the full currently implemented ATV-Teams plugin surface in one package.
...
- Some SDK-defined host surfaces still depend on the ATV-Teams host wiring them visibly; this package aims to exercise the currently mounted ones and make the rest obvious.
