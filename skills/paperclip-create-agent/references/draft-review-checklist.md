...
- [ ] The first paragraph points at the ATV-Teams skill as the source of truth for the heartbeat procedure
...
- [ ] For execution-heavy roles (coders, operators, designers, security, QA), `AGENTS.md` includes the ATV-Teams execution contract verbatim:
...
- [ ] Adapter config matches this ATV-Teams instance (cwd, model, credentials) per `/llms/agent-configuration/<adapter>.txt`
