...
One or two sentences. Name the agent, its role, and its company. State the reporting line. Point at the ATV-Teams heartbeat skill as the source of truth for the wake procedure.
...
When you wake up, follow the ATV-Teams skill - it contains the full heartbeat procedure.
