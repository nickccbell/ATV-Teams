...
const mockCompanyState = vi.hoisted(() => ({
  companies: [{ id: "company-1", issuePrefix: "PAP", name: "ATV-Teams" }],
  selectedCompany: { id: "company-1", issuePrefix: "PAP", name: "ATV-Teams" },
...
describe("Layout", () => {
  ...
  beforeEach(() => {
    ...
    mockCompanyState.companies = [{ id: "company-1", issuePrefix: "PAP", name: "ATV-Teams" }];
    mockCompanyState.selectedCompany = { id: "company-1", issuePrefix: "PAP", name: "ATV-Teams" };
  ...
  it("uses the route company context for plugin route sidebars on the first render", async () => {
    ...
    mockCompanyState.companies = [
      { id: "company-1", issuePrefix: "PAP", name: "ATV-Teams" },
