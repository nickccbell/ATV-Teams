  ...
  return (
    ...
    >
      <MDXEditor
        ...
        className={cn("atv-mdxeditor", !bordered && "atv-mdxeditor--borderless")}
        contentEditableClassName={cn(
          "atv-mdxeditor-content focus:outline-none [&_ul]:list-disc [&_ul]:pl-5 [&_ol]:list-decimal [&_ol]:pl-5 [&_li]:list-item",
          contentClassName,
        )}
