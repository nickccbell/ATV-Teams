...
export const AGENT_ORDER_UPDATED_EVENT = "atv-teams:agent-order-updated";
export const AGENT_SORT_MODE_UPDATED_EVENT = "atv-teams:agent-sort-mode-updated";
const AGENT_ORDER_STORAGE_PREFIX = "atv-teams.agentOrder";
const AGENT_SORT_MODE_STORAGE_PREFIX = "atv-teams.agentSortMode";
