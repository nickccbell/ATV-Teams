...
export const PROJECT_ORDER_UPDATED_EVENT = "atv-teams:project-order-updated";
export const PROJECT_SORT_MODE_UPDATED_EVENT = "atv-teams:project-sort-mode-updated";
const PROJECT_ORDER_STORAGE_PREFIX = "atv-teams.projectOrder";
const PROJECT_SORT_MODE_STORAGE_PREFIX = "atv-teams.projectSortMode";
