...
describe("ImportFromVaultDialog", () => {
  ...
  it("blocks import when a review row collides with an existing ATV-Teams secret", async () => {
    ...
    expect(document.body.textContent?.toLowerCase()).toContain("an atv-teams secret already uses this");
  ...
  it("renders sanitized preview provider errors without raw AWS exception text", async () => {
    const rawProviderMessage =
      "AccessDeniedException: User: arn:aws:sts::123456789012:assumed-role/prod/ATV-Teams is not authorized";
