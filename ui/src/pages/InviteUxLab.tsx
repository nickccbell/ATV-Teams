  ...
  return (
    <>
      <div className="flex items-start gap-4">
        ...
        />
        <div className="min-w-0">
          <p className="text-xs uppercase tracking-[0.24em] text-zinc-500">You&apos;ve been invited to join ATV-Teams</p>
    ...
    <div className="space-y-5">
      <div>
        ...
        <p className="mt-1 text-sm text-zinc-400">
          {mode === "sign_up"
            ? "Start with a ATV-Teams account. After that, you'll come right back here to accept the invite for Acme Robotics."
      ...
      <Card className="rounded-[28px] shadow-none">
        ...
        <CardContent className="space-y-4">
          ...
          <div className="space-y-3 rounded-2xl border border-border px-4 py-4">
            <div className="flex items-center justify-between gap-3">
              <div>
                ...
                <div className="text-sm text-muted-foreground">
                  This URL includes the current ATV-Teams domain returned by the server.
                </div>
              </div>
            ...
            >
              https://atv-teams.local/invite/new-token
            </button>
          ...
          <InviteLandingShell
            left={
              <InviteSummaryPanel
                ...
                description="Create your ATV-Teams account first. If you already have one, switch to sign in and continue the invite with the same email."
