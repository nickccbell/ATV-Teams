...
export function Routines() {
  ...
  const routineViewStateKey = selectedCompanyId
    ? `atv-teams:routines-view:${selectedCompanyId}`
    : "atv-teams:routines-view";
  ...
  const updateRoutineStatus = useMutation({
    ...
    onError: (mutationError) => {
      pushToast({
        ...
        body: mutationError instanceof Error ? mutationError.message : "ATV-Teams could not update the routine.",
        tone: "error",
      });
    },
  });
      ...
      <Tabs value={activeTab} onValueChange={handleTabChange}>
        ...
        <TabsContent value="runs">
          <IssuesList
            ...
            viewStateKey="atv-teams:routine-recent-runs-view"
        ...
        >
          ...
          <div className="shrink-0 flex flex-col gap-3 border-t border-border/60 px-5 py-4 sm:flex-row sm:items-center sm:justify-between">
            <div className="text-sm text-muted-foreground">
              After creation, ATV-Teams takes you straight to trigger setup. Draft routines stay paused until you add a default agent.
            </div>
