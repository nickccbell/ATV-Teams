...
export const runTranscriptFixtureEntries: TranscriptEntry[] = [
  ...
  },
  {
    ...
    text: "I’m starting with the ATV-Teams heartbeat procedure and the repo-required docs so I can see what task is actually assigned and then work only on that scope.",
  },
  {
    kind: "tool_call",
