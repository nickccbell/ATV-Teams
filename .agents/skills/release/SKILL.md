...
name: release
description: >
  Coordinate a full ATV-Teams release across engineering verification, npm,
...
Run the full ATV-Teams maintainer release workflow, not just an npm publish.
...
7. If running through ATV-Teams, you have issue context for status updates and follow-up task creation.
...
ATV-Teams now uses a commit-driven release model:
...
- release summary in ATV-Teams issue context
