...
Manage companies within your ATV-Teams instance.
...
Company logo uploads use the normal ATV-Teams attachment size limit.
...
| `logoUrl` | string | Optional ATV-Teams asset content path for the stored logo image |
