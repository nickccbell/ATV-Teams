...
- Running a Python script that calls the ATV-Teams API
...
1. ATV-Teams spawns the configured command as a child process
2. Standard ATV-Teams environment variables are injected (`PAPERCLIP_AGENT_ID`, `PAPERCLIP_API_KEY`, etc.)
...
The script can use the injected environment variables to authenticate with the ATV-Teams API and perform work.
