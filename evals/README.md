...
Eval framework for testing ATV-Teams agent behaviors across models and prompt versions.
...
Phase 0 covers narrow behavior evals for the ATV-Teams heartbeat skill:
