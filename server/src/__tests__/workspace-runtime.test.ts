...
describe("sanitizeRuntimeServiceBaseEnv", () => {
  it("removes inherited ATV-Teams and pnpm auth flags before spawning runtime services", () => {
...
describe("realizeExecutionWorkspace", () => {
  ...
  it("writes an isolated repo-local ATV-Teams config and worktree branding when provisioning", async () => {
    const repoRoot = await createTempRepo();
...
describe("ensureRuntimeServicesForRun", () => {
  ...
  it("does not leak parent ATV-Teams instance env into runtime service commands", async () => {
