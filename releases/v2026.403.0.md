...
- **Routines skill** — New `paperclip-routines` skill with documentation moved into ATV-Teams references. Routine runs now support workspace awareness and variables. ([#2414](https://github.com/paperclipai/paperclip/pull/2414), @aronprins)
...
- **Commit metrics** — New ATV-Teams commit metrics script with filtered exports and edge case handling.
